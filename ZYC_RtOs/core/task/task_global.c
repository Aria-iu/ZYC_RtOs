...
LOGI("g_tskCbArray[%d].stackCfgFlg 			is %d\n",i,g_tskCbArray[i].stackCfgFlg);
LOGI("g_tskCbArray[%d].priority 			is %d\n",i,g_tskCbArray[i].priority);
LOGI("g_tskCbArray[%d].topOfStack 			is 0x%x\n",i,g_tskCbArray[i].topOfStack);
LOGI("g_tskCbArray[%d].name 			is %s\n",i,g_tskCbArray[i].name);
LOGI("----------------------------------------------------------------------------------------\n");
}
...
void dump_task(int i){
	LOGI("address: 0x%x\n",g_tskCbArray[i]);
	LOGI("address stackPointer is 0x%x\n",&(g_tskCbArray[i].node));
	LOGI("TCB'node: %x\n",g_tskCbArray[i].node);
	 LOGI("TCB'stackPointer address: %p\n",&g_tskCbArray[i].stackPointer);
